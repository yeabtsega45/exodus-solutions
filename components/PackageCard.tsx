...
export default function PackageCard({
  ...
  return (
    <div className="bg-white rounded-lg shadow-lg border-2 border-gray-200 hover:border-[#6c5ce7] transition-all duration-300 overflow-hidden flex flex-col h-full">
